...
class AccountServiceImpl implements AccountService {
    ...
    public void update(AccountDTO accountDTO) {
        Account account = accountRepository.findById(accountDTO.getId()).orElseThrow(NoResultException::new);
        if (account != null) {
    ...
    public void delete(Long id) {
        Account account = accountRepository.findById(id).orElseThrow(NoResultException::new);
        if (account != null) {
